  ...
  $('.colors-large a').click(function(){return false;});
	...
	$('.add_to_cart').click(function(){
		...
		setTimeout(function(){
			...
			var cartItem = "<div class='cart-item'><div class='img-wrap'><img src='"+productImage+"' alt='' /></div><span>"+productName+"</span><strong>$1</strong><div class='cart-item-border'></div><div class='delete-item'></div></div>";			
